...
Days carrying one of the *other* kinds show a small dot (blue scheduled, red deadline, violet other-planned, accent for today). There is no month swipe: the `‹` / `›` arrows are the only way to change months.
