...
One-tap presets for the most common targets: **Today**, **Tomorrow**, **This weekend**, **Next week**, each labeled with the resolved date. They show on every tab, including before a date is set: with nothing set they appear under the calendar hint, and once a date exists they sit below it in the stamp editor.
