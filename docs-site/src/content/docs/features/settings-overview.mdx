...
Settings is reachable from the navigation drawer. It's a single hub screen linking out to nine focused sub-pages, each documented in its own page linked below.

<ThemeShot
  light={settingsLight}
  dark={settingsDark}
  alt="Settings hub listing nine rows: Look and Feel, Notebooks, Capture Templates, Sync, Notes, Agenda, Reminders, Sharing, Backup, plus Report a bug and Tips & Tricks links under Help and the app version shown below"
  widths={[340, 680]}
  sizes="340px"
/>
