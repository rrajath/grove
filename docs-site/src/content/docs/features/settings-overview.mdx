...
<ThemeShot
  light={settingsLight}
  dark={settingsDark}
  alt="Settings hub listing eight rows: Look and Feel, Capture Templates, Sync, Notes, Agenda, Reminders, Sharing, Backup, plus Report a bug and Tips & Tricks links under Help and the app version shown below"
  widths={[340, 680]}
  sizes="340px"
/>
