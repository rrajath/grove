...
| Section | Covers | Docs |
|---|---|---|
| **Look and Feel** | Theme, launcher-icon sync | [Themes & Appearance](/features/themes-appearance) |
...
| **Notes** | TODO keywords, priority, default note mode, read/edit-mode font size, read-mode display toggles, checklist states, IDs, auto-archive | [Notes Behavior](/features/notes-behavior) |
