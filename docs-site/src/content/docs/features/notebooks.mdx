...
<ThemeShot
  ...
  dark={notebooksDark}
  alt="Notebooks list showing six notebooks (ideas.org, inbox.org, journal.org, reading.org, recipes.org, travel.org) with icon glyphs, note counts, last-modified times, a Conflict pill on journal.org, and a Capture FAB"
  widths={[340, 680]}
  sizes="340px"
/>
...
- **Icon glyph and color**: a small colored tile with a symbol, customizable per notebook (long-press → *Icon & color*)
